...
class ManageInfo(models.Model):
    account = models.CharField(verbose_name='账户', max_length=11)
    nickname = models.CharField(verbose_name='昵称', max_length=64)
...
class Topic(models.Model):
    ...
    count = models.PositiveIntegerField(verbose_name='该类数量', default=0)
...
class News(models.Model):
    ...
    kinds = models.CharField(verbose_name='类型', max_length=255 , null=True, blank=True)
...
class CommentRecord(models.Model):
    ...
    favor_count = models.PositiveIntegerField(verbose_name='赞数', default=0)
    root = models.ForeignKey(verbose_name='根评论',to='self',null=True,blank=True,related_name="roots",on_delete=models.CASCADE)
